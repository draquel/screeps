...
module.exports = {
  ...
  runRole(creep) {
    switch (creep.memory.role) {
      ...
      case "builder":
        ...
        break;
      case "maintenance":
        this.runMaintenance(creep);
        break;
      case "d-maintenance":
        this.runDMaintenance(creep);
        break;
      case "transporter":
  ...
  runWorker(creep){
    ...
    if(creep.memory.working){
      if (!work.refillBaseEnergy(creep, {
          terminal: false,
          storages: false,
          containers: false,
          links: false,
        ...
        filter: (s) => {
          return (
            (((s.structureType === STRUCTURE_SPAWN &&
              ...
              s.store.getFreeCapacity(resource) >
              s.store.getCapacity(resource) * 0.25) ||
